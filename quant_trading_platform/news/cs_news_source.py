...
class CSNewsSource(BaseNewsSource):
    """中国证券报新闻源"""
    
    def __init__(self):
        self.logger = logger
        self.base_url = "http://www.cs.com.cn"
        self.headers = {
    ...
    def get_stock_news(self, symbol: str, limit: int = 10) -> List[Dict]:
        ...
        self.logger.info(f"从中国证券报获取到 {len(news_list)} 条新闻")
    ...
    def get_market_news(self, limit: int = 20) -> List[Dict]:
        ...
        self.logger.info(f"从中国证券报获取到 {len(news_list)} 条市场新闻")
        return news_list[:limit]
