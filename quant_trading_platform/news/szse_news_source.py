...
class SZSENewsSource(BaseNewsSource):
    """深圳证券交易所新闻源"""
    ...
    def get_stock_news(self, symbol: str, limit: int = 10) -> List[Dict]:
        ...
        try:
            # 深交所公告信息URL
            url = f"{self.base_url}/disclosure/bulletinDetail/{symbol}.html"
            ...
            self.logger.info(f"从深交所获取到 {len(news_list)} 条新闻")
            return news_list[:limit]
            
        except Exception as e:
            self.logger.warning(f"从深交所获取新闻失败: {str(e)}")
            return news_list
    ...
    def get_market_news(self, limit: int = 20) -> List[Dict]:
        ...
        try:
            # 深交所市场新闻URL
            url = f"{self.base_url}/disclosure/notice/general/"
            ...
            self.logger.info(f"从深交所获取到 {len(news_list)} 条市场新闻")
            return news_list[:limit]
            
        except Exception as e:
            self.logger.warning(f"从深交所获取市场新闻失败: {str(e)}")
            return news_list
