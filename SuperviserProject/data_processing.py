...
class DataProcessing:
    ...
    def get_data(self):
        ...
        df_1 = pd.read_csv("data/original/hospital_info.csv")
        ...
        xy_col = """
                    ...
                    """
        sql_2 = """
                SELECT {} FROM WCL.syoe_xyba_view WHERE substr(cysj, 1, 6) = '{}{}'
        ...
        zy_col = """
                    ...
                    """
        sql_3 = """
                SELECT {} FROM WCL.syoe_zyba_view WHERE substr(cysj, 1, 6) = '{}{}'
