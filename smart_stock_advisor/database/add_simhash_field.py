...
def execute_sql_script():
    """执行SQL脚本"""
    sql_file = os.path.join(os.path.dirname(__file__), 'add_simhash_field.sql')
...
if __name__ == "__main__":
    print("=" * 60)
    print("执行 add_simhash_field.sql 脚本")
    print("=" * 60)
    ...
    if success:
        print("\n✅ simhash字段添加成功！")
        print("现在可以正常使用SimHash相似度检测功能了。")
        sys.exit(0)
    else:
        print("\n⚠️  执行过程中遇到一些问题，请检查上面的错误信息。")
        sys.exit(1)
