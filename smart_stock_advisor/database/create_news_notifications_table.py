#!/usr/bin/env python3
"""
执行 news_notification_table.sql 脚本
...
def execute_sql_script():
    """执行SQL脚本"""
    sql_file = os.path.join(os.path.dirname(__file__), 'news_notification_table.sql')
...
if __name__ == "__main__":
    print("=" * 60)
    print("执行 news_notification_table.sql 脚本")
    print("=" * 60)
    
    success = execute_sql_script()
    
    if success:
        print("\nnews_notifications表创建成功！")
        print("现在可以正常使用新闻推送通知功能了。")
        sys.exit(0)
    else:
